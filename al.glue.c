...
int al$run_main(int argc, char ** argv, int (*arg2)(int arg0, char ** arg1))
{
...
int al$emit_user_event(ALLEGRO_EVENT_SOURCE * arg0, ALLEGRO_EVENT * arg1, void (*dtor)(ALLEGRO_USER_EVENT * arg0))
{
...
void al$register_assert_handler(void (*handler)(const char * expr, const char * file, int line, const char * func))
{
	return al_register_assert_handler(handler);
}
void al$register_trace_handler(void (*handler)(const char * arg0))
{
...
int al$for_each_fs_entry(ALLEGRO_FS_ENTRY * dir, int (*callback)(ALLEGRO_FS_ENTRY * entry, void * extra), void * extra)
{
...
int al$install_system(int version, int (*atexit_ptr)(void (*arg0)()))
{
...
ALLEGRO_THREAD * al$create_thread(void * (*proc)(ALLEGRO_THREAD * thread, void * arg), void * arg)
{
...
void al$run_detached_thread(void * (*proc)(void * arg), void * arg)
{
